...
module sg13g2_dfrbp_1 (Q, Q_N, CLK, D, RESET_B);
	...
	buf (xcr_0, 0);
	ihp_dff_r  u_prim_838 (int_fwire_IQ, notifier, delayed_CLK, delayed_D, int_fwire_r, xcr_0);
	buf (Q, int_fwire_IQ);
...
module sg13g2_dfrbp_2 (Q, Q_N, CLK, D, RESET_B);
	...
	not (int_fwire_r, delayed_RESET_B);
	buf (xcr_0, 0);
	ihp_dff_r  u_prim_885 (int_fwire_IQ, notifier, delayed_CLK, delayed_D, int_fwire_r, xcr_0);
	buf (Q, int_fwire_IQ);
	not (int_fwire_IQN, int_fwire_IQ);
	buf (Q_N, int_fwire_IQN);
...
module sg13g2_dfrbpq_1 (Q, CLK, D, RESET_B);
	...
	not (int_fwire_r, delayed_RESET_B);
	buf (xcr_0, 0);
	ihp_dff_r  u_prim_931 (int_fwire_IQ, notifier, delayed_CLK, delayed_D, int_fwire_r, xcr_0);
	buf (Q, int_fwire_IQ);
...
module sg13g2_dfrbpq_2 (Q, CLK, D, RESET_B);
	...
	not (int_fwire_r, delayed_RESET_B);
	buf (xcr_0, 0);
	ihp_dff_r  u_prim_972 (int_fwire_IQ, notifier, delayed_CLK, delayed_D, int_fwire_r, xcr_0);
	buf (Q, int_fwire_IQ);
...
module sg13g2_dlhq_1 (Q, D, GATE);
	...
	ihp_latch  u_prim_1012 (int_fwire_IQ, notifier, delayed_GATE, delayed_D);
	buf (Q, int_fwire_IQ);
...
module sg13g2_dlhr_1 (Q, Q_N, D, GATE, RESET_B);
	...
	not (int_fwire_r, delayed_RESET_B);
	ihp_latch_r  u_prim_1051 (int_fwire_IQ, notifier, delayed_GATE, delayed_D, int_fwire_r);
	buf (Q, int_fwire_IQ);
	not (int_fwire_IQN, int_fwire_IQ);
	buf (Q_N, int_fwire_IQN);
...
module sg13g2_dlhrq_1 (Q, D, GATE, RESET_B);
	...
	not (int_fwire_r, delayed_RESET_B);
	ihp_latch_r  u_prim_1101 (int_fwire_IQ, notifier, delayed_GATE, delayed_D, int_fwire_r);
	buf (Q, int_fwire_IQ);
...
module sg13g2_dllr_1 (Q, Q_N, D, GATE_N, RESET_B);
	...
	not (int_fwire_r, delayed_RESET_B);
	ihp_latch_r  u_prim_1146 (int_fwire_IQ, notifier, int_fwire_clk, delayed_D, int_fwire_r);
	buf (Q, int_fwire_IQ);
	not (int_fwire_IQN, int_fwire_IQ);
	buf (Q_N, int_fwire_IQN);
...
module sg13g2_dllrq_1 (Q, D, GATE_N, RESET_B);
	...
	not (int_fwire_clk, delayed_GATE_N);
	not (int_fwire_r, delayed_RESET_B);
	ihp_latch_r  u_prim_1197 (int_fwire_IQ, notifier, int_fwire_clk, delayed_D, int_fwire_r);
	buf (Q, int_fwire_IQ);
...
module sg13g2_lgcp_1 (GCLK, CLK, GATE);
	...
	ihp_latch  u_prim_1739 (int_fwire_int_GATE, notifier, int_fwire_clk, delayed_GATE);
...
module sg13g2_mux2_1 (X, A0, A1, S);
	...
	ihp_mux2  u_prim_1773 (X, A0, A1, S);
...
module sg13g2_mux2_2 (X, A0, A1, S);
	...
	ihp_mux2  u_prim_1817 (X, A0, A1, S);
...
module sg13g2_mux4_1 (X, A0, A1, A2, A3, S0, S1);
	...
	ihp_mux4  u_prim_1860 (X, A0, A1, A2, A3, S0, S1);
...
module sg13g2_sdfbbp_1 (Q, Q_N, CLK, D, RESET_B, SCD, SCE, SET_B);
	...
	ihp_mux2  u_prim_2715 (int_fwire_d, delayed_D, delayed_SCD, delayed_SCE);
	not (int_fwire_s, delayed_SET_B);
	not (int_fwire_r, delayed_RESET_B);
	buf (xcr_0, 0);
	ihp_dff_sr_1  u_prim_2719 (int_fwire_IQ, notifier, delayed_CLK, int_fwire_d, int_fwire_s, int_fwire_r, xcr_0);
	buf (Q, int_fwire_IQ);
	not (int_fwire_IQN, int_fwire_IQ);
	buf (Q_N, int_fwire_IQN);
...
module sg13g2_sdfrbp_1 (Q, Q_N, CLK, D, RESET_B, SCD, SCE);
	...
	ihp_mux2  u_prim_2786 (int_fwire_d, delayed_D, delayed_SCD, delayed_SCE);
	not (int_fwire_r, delayed_RESET_B);
	buf (xcr_0, 0);
	ihp_dff_r  u_prim_2789 (int_fwire_IQ, notifier, delayed_CLK, int_fwire_d, int_fwire_r, xcr_0);
	buf (Q, int_fwire_IQ);
	not (int_fwire_IQN, int_fwire_IQ);
	buf (Q_N, int_fwire_IQN);
...
module sg13g2_sdfrbp_2 (Q, Q_N, CLK, D, RESET_B, SCD, SCE);
	...
	ihp_mux2  u_prim_2850 (int_fwire_d, delayed_D, delayed_SCD, delayed_SCE);
	not (int_fwire_r, delayed_RESET_B);
	buf (xcr_0, 0);
	ihp_dff_r  u_prim_2853 (int_fwire_IQ, notifier, delayed_CLK, int_fwire_d, int_fwire_r, xcr_0);
	buf (Q, int_fwire_IQ);
	not (int_fwire_IQN, int_fwire_IQ);
	buf (Q_N, int_fwire_IQN);
...
module sg13g2_sdfrbpq_1 (Q, CLK, D, RESET_B, SCD, SCE);
	...
	ihp_mux2  u_prim_2914 (int_fwire_d, delayed_D, delayed_SCD, delayed_SCE);
	not (int_fwire_r, delayed_RESET_B);
	buf (xcr_0, 0);
	ihp_dff_r  u_prim_2917 (int_fwire_IQ, notifier, delayed_CLK, int_fwire_d, int_fwire_r, xcr_0);
	buf (Q, int_fwire_IQ);
...
module sg13g2_sdfrbpq_2 (Q, CLK, D, RESET_B, SCD, SCE);
	...
	ihp_mux2  u_prim_2972 (int_fwire_d, delayed_D, delayed_SCD, delayed_SCE);
	not (int_fwire_r, delayed_RESET_B);
	buf (xcr_0, 0);
	ihp_dff_r  u_prim_2975 (int_fwire_IQ, notifier, delayed_CLK, int_fwire_d, int_fwire_r, xcr_0);
	buf (Q, int_fwire_IQ);
...
module sg13g2_slgcp_1 (GCLK, GATE, CLK, SCE);
	...
	ihp_latch  u_prim_3032 (int_fwire_int_GATE, notifier, int_fwire_clk, int_fwire_test);
	and (GCLK, delayed_CLK, int_fwire_int_GATE);
